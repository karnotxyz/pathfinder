...
use pathfinder_common::{
    ...
    L1BlockNumber, L1DataAvailabilityMode, L1ToL2MessageNonce, L1ToL2MessagePayloadElem,
    L2ToL1MessagePayloadElem, ReceiptCommitment, SequencerAddress, SierraHash, StarknetVersion,
    StateCommitment, StateDiffCommitment, StorageAddress, StorageCommitment, StorageValue,
